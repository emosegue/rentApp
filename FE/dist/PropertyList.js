...
function getPropertiesAsync(_x) {
  return _getPropertiesAsync.apply(this, arguments);
}

function _getPropertiesAsync() {
  _getPropertiesAsync = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(filter) {
    var response, data;
  ...
  _createClass(PropertyList, [{
    ...
    value: function () {
      var _componentWillReceiveProps = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(nextProps) {
        var filters, dataProperties;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                filters = nextProps ? nextProps.value : {};
                _context2.next = 3;
                return getPropertiesAsync(filters);
